...
urlpatterns = [
    ...
    path('api/employees/<int:employee_id>/roles/', RoleViewSet.as_view({'get': 'employee_roles', 'post': 'employee_roles'}), name='employee-role-list-create'),
    ...
    path('apilemployees/<int:id>/role-history/', employee_role_history, name='employee_role_history'),
